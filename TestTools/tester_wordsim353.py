...
# -*- coding: utf-8 -*-
# @Author: largelymfs
# @Date:   2014-08-19 14:32:59
# @Last Modified by:   largelymfs
# @Last Modified time: 2014-08-19 15:16:19
...
def get_rank(score):
    ...
    tmp = sorted(tmp, cmp=lambda x, y: -cmp(x[1], y[1]))
...
if __name__ == "__main__":
    #words_number, words_dim, word2vector = load_vector(sys.argv[1])
    l = len(sys.argv)
    if l < 2:
        test_filename = "wordsim353"
    else:
        test_filename = sys.argv[2]
    print test_wordsim353(sys.argv[1], test_filename)
